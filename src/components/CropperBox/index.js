...
const CropperBox = (props) => {
  ...
  const { title = t('cropImg.title'), tip = 'avatar', visible, aspectRatio = 1, srcCropper, onCloseModal, cropperBtn } = props;
  ...
  return (
    ...
    >
      ...
      <Dialog.Footer style={{textAlign: 'center'}}>
        <Button className={styleModalContainerBtn} onClick={submitBtn}>{t('save')}</Button>
      </Dialog.Footer>
    </Dialog>
  )
}
