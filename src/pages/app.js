...
const App = (props) => {
	...
	return (
		<section className={styles.container}>
			<Box
				className={cx(styleLeftNav, shrink && styleLeftFull)}
						...
						return (
							<nav
								...
								className={`${styles.nav} ${isActive && styles.navActive} ${
									shrink ? styles.navRt : styles.navBot
								} styleNavContainer`}
							>
								<div className={styles.navImg}>
									{
										<img
											src={isActive ? obj.icon_Select : obj.icon}
											style={{ width: 18 }}
											alt={obj.navName}
										/>
									}
								...
								<span
									className={`${styles.navDeText} ${isActive && styles.navDeActive} styleNavText`}
								>
