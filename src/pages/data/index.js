	...
	const data = [
		{
			...
			title: 'AI data',
			caption:
				"Introducing the Developer home for our protocol's developer experience. Protocols in crypto",
			btnText: 'Coming soon',
		},
		{
			avatar: intersect1,
	...
	return (
		<div className={styles.boxMain}>
			...
			<div className={styles.boxDesc}>
				Introducing the Developer home for our protocol's developer experience. Protocols in crypto
				<br />
				are incredibly powerful and also complicated.
			</div>
			<div className={styles.boxCard}>
				{data.map((obj, index) => (
					<div key={index} className={styles.box_card_product}>
						...
						<h5>{obj.caption}</h5>
						<div
							onClick={() => handleLink(obj.link)}
							className={`${styles.box_btn} ${!obj.link ? styles.box_btn_come : null}`}
						>
							{obj.btnText}
						</div>
					</div>
