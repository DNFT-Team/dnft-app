...
const ProfileEditScreen = (props) => {
	...
	const editProfile = async () => {
		...
		try {
			...
			formData.append(
				'twitterAddress',
				form?.twitterAddress ? 'https://twitter.com/' + form?.twitterAddress : '',
			)
			formData.append(
				'facebookAddress',
				form?.facebookAddress ? 'https://www.instagram.com/' + form?.facebookAddress : '',
			)
			formData.append(
				'youtubeAddress',
				form?.youtubeAddress ? 'https://www.youtube.com/' + form?.youtubeAddress : '',
			)
