...
export const tradableNFTAbi721 = [
	{
		anonymous: false,
		inputs: [
			{
		...
		outputs: [
			{
				...
				internalType: 'struct DnftTradable721.NftInfo',
				name: '',
				type: 'tuple',
			},
		],
		...
		outputs: [
			{
				components: [
					...
					{
						internalType: 'enum DnftTradable721.PayMod',
						name: 'payMod',
						type: 'uint8',
					},
					{
				...
				internalType: 'struct DnftTradable721.Item',
				name: '',
				type: 'tuple',
			},
		],
...
export const auction721Abi = [
	...
	},
	{
		...
		inputs: [
			...
			{
				indexed: false,
				internalType: 'enum Auction721.Status',
				name: 'status',
				type: 'uint8',
			},
		],
		...
		outputs: [
			{
				...
				internalType: 'struct Auction721.AuctionInfo',
				name: '',
				type: 'tuple',
			},
		],
		...
		outputs: [
			{
				components: [
					...
					},
					{
						...
						internalType: 'struct Auction721.NftInfo',
						name: 'nftInfo',
						type: 'tuple',
					},
					{
						internalType: 'enum Auction721.PayMod',
						name: 'payMod',
						type: 'uint8',
					},
					{
					...
					{
						internalType: 'uint256',
						name: 'realClaimAmount',
						type: 'uint256',
					},
				],
				internalType: 'struct Auction721.LotInfo',
				name: '',
				type: 'tuple',
			},
		],
