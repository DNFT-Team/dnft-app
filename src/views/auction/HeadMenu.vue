<template>
  <div class="market-head-menu">
    <div class="category-list">
      <span :class="{'selected': selected === 'all'}" @click="handleSelect('all')">所有目录</span>
...
export default {
  ...
  methods: {
    handleCreateNFT() {
      this.$router.push('/acreatenft');
    },
    handleCteateNFTCategory() {
      this.$router.push('/acreatenftcategory');
    },
    handleSelect(value) {
      this.selected = value;
    },
